...
/**
 * reference: http://mnemstudio.org/particle-swarm-tsp-example-1.htm
 *
 * the code below is taken from online and remodified
 */
...
import java.util.ArrayList;
import java.util.Random;
class TSP_PSO implements Runnable{
    ...
    public static ArrayList<Double> data_collector = new ArrayList<>();
    ...
    private static void PSOAlgorithm()
    {
        ...
        while(!done)
        {
            ...
            if(epoch < MAX_EPOCHS){
                ...
                data_collector.add(particles.get(0).pBest());
                getVelocity();
