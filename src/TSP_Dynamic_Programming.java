...
public class TSP_Dynamic_Programming implements Runnable {
    ...
    public TSP_Dynamic_Programming(double[][] distance) {
        this(0, distance);
    }

    public TSP_Dynamic_Programming(int start, double[][] distance) {
        N = distance.length;
    ...
    public static double getTourDistance() {
        if (!ranSolver) {
            solve();
        }
        return minTourCost;
    ...
    @Override
    public void run() {
        System.out.println("TSP Dynamic Programming Tour: " + TSP_Dynamic_Programming.getTour());
        System.out.println("Total Distance: " + TSP_Dynamic_Programming.getTourDistance());
        System.out.println("Total Iteration: " + TSP_Dynamic_Programming.counter);
    }
}